...
const ContactPage: React.FC = () => {
  ...
  const contactCardStyle =
    "flex items-center gap-5 p-5 bg-[#111]/80 backdrop-blur-sm border border-neutral-800/60 rounded-2xl text-neutral-400 hover:text-white hover:bg-[#151515] transition-all duration-500 hover:-translate-y-1 hover:shadow-xl group cursor-pointer";
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-neutral-400 max-w-5xl mx-auto leading-relaxed">
            Seja para uma nova oportunidade, um projeto desafiador ou apenas
            para trocar ideias sobre código e arquitetura, minha caixa de
            entrada está aberta.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 lg:gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col justify-center space-y-4">
            {/* E-mail */}
            <a
              href="mailto:gabrieldebonis@gmail.com"
              className={`${contactCardStyle} hover:border-emerald-500/30 hover:shadow-emerald-500/5`}
            >
              <div className="p-4 rounded-xl bg-neutral-900 group-hover:bg-emerald-500/20 group-hover:text-emerald-400 transition-all duration-500">
                <svg
                  className="w-7 h-7 transform group-hover:scale-110 transition-transform duration-500"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={1.5}
            ...
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/in/gabrieldebonis/"
              target="_blank"
              rel="noreferrer"
              className={`${contactCardStyle} hover:border-[#0A66C2]/30 hover:shadow-[#0A66C2]/5`}
            >
            ...
            {/* WhatsApp (NOVO!) */}
            <a
              href="https://wa.me/5511933868414"
              target="_blank"
              rel="noreferrer"
              className={`${contactCardStyle} hover:border-[#25D366]/30 hover:shadow-[#25D366]/5`}
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className={`${contactCardStyle} border-amber-500/20 hover:border-amber-500/50 hover:shadow-amber-500/10 overflow-hidden relative`}
            >
              {/* Efeito de brilho sutil no fundo */}
              <div className="absolute top-0 right-0 w-20 h-20 bg-amber-500/5 blur-2xl rounded-full"></div>

              <div className="p-4 rounded-xl bg-neutral-900 group-hover:bg-amber-500/20 group-hover:text-amber-500 transition-all duration-500">
                <svg
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-neutral-500 group-hover:text-neutral-300 transition-colors">
                  Contribua com este projeto via Mercado Pago
                </p>
              </div>

              {/* Seta indicativa que aparece no hover */}
              <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-500 pr-2">
                <svg
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  <label
                    htmlFor="name"
                    className="text-xs font-bold uppercase tracking-wider text-neutral-500 pl-1"
                  >
                    Seu Nome
                  </label>
                  <input
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-r from-blue-600 via-emerald-500 to-blue-600 transition-opacity duration-500 ${isHovered ? "opacity-100" : "opacity-80"}`}
                ></div>
