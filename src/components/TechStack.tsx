...
const TechStack: React.FC = () => {
  const techStack = [
    ...
    },
    {
      ...
      skills: [
        { name: "PySpark", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/apache/apache-original.svg" },
    ...
    {
      category: "Linguagens & Banco de Dados",
      skills: [
    ...
    {
      category: "Cloud, DevOps & Ferramentas",
      skills: [
